...
class SiteSettingResource extends Resource
{
    ...
    public static function getNavigationLabel(): string { return 'Налаштування сайту'; }
    public static function getModelLabel(): string { return 'налаштування'; }
    public static function getPluralModelLabel(): string { return 'Налаштування сайту'; }
    public static function form(Schema $schema): Schema { return $schema->components([
        ...
        FileUpload::make('value')->label('Зображення')->image()->directory('settings')->visibility('public')->visible(fn ($get) => $get('type') === 'image')->columnSpanFull(),
    ...
    public static function getPages(): array { return ['index'=>ListSiteSettings::route('/'),'create'=>CreateSiteSetting::route('/create'),'edit'=>EditSiteSetting::route('/{record}/edit')]; }
}
